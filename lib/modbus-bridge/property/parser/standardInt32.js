...
class StandardInt32 extends BaseParser {
    constructor(conf) {
    ...
    fromHomie(data) {
        ...
        buf[`write${this.signed ? '' : 'U'}Int32${this.bigendian ? 'BE' : 'LE'}`](data, 0);
    ...
    toHomie(data) {
        ...
        return `${buf[`read${this.signed ? '' : 'U'}Int32${this.bigendian ? 'BE' : 'LE'}`](0)}`;
    }
}

module.exports = StandardInt32;
